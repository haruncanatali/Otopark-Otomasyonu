...
namespace Otopark.DataAccess.Migrations
{
    public partial class DboOtoparkMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Yer = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
                    Cephe = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Araclar_Konumlar_KonumId",
                        column: x => x.KonumId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ParkSuresi = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
